    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('liked', models.ManyToManyField(default=None, related_name='like', to='profiles.profile')),
            ],
            options={
                'ordering': ('-updated',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='like_profile', to='profiles.profile')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
